          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Digital Marketing Co joined the platform</p>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">New API key created for AdTech Solutions</p>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Sarah Johnson promoted to admin</p>
              </div>
